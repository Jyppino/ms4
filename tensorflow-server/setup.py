...
REQUIRED_PACKAGES = ['Pillow>=1.0', 'Flask', 'tensorflow', 'six', 'matplotlib', 'google-cloud', 'google', 'Pillow']

setup(
    name='MyShelf Book Detection',
    version='1.0',
    install_requires=REQUIRED_PACKAGES,
    include_package_data=True,
    packages=[p for p in find_packages()],
    description='MyShelf Book Detection',
)

'''Download the Tensorflow Object Dectection directory'''
